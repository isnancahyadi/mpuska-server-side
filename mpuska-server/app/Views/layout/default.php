...
<body>
        ...
        <div class="main-wrapper">
            ...
            <nav class="navbar navbar-expand-lg main-navbar">
                <form class="form-inline mr-auto">
                    ...
                    <div class="navbar-text"><?= date('d F Y') ?></div>
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2021
                    <div class="bullet"></div> Dev By Isnan Arif Cahyadi
                    <div class="bullet"></div> Design Template By <a href="https://nauval.in/">Muhamad Nauval Azhar (Stisla)</a>
                </div>
    ...
    <script src="<?= base_url() ?>/template/node_modules/bootstrap-tagsinput/dist/bootstrap-tagsinput.js"></script>
